%define VMODNAME   libvmod-imgdata
%define VMODSRC    %{_builddir}/%{VMODNAME}
%define VARNISHSRC ../SOURCES/varnish-3.0.4

Summary: Imgdata VMOD for Varnish
Name: varnish-vmod-imgdata
Version: 0.1
Release: 1%{?dist}
License: BSD
Group: System Environment/Daemons
Source0: libvmod-imgdata.tar.gz
BuildRoot: %{_tmppath}/%{name}-%{version}-%{release}-root-%(%{__id_u} -n)
Requires: varnish > 3.0
BuildRequires: make, python-docutils

%description
Varnish vmod hack demonstrating how to imgdata HTML content. It's not production-ready - I'm still learning and looking for the best way how to do it. https://github.com/pbruna/libvmod-imgdata

%prep
%setup -n libvmod-imgdata
